...
namespace KRG::Serialization
{
    ...
    KRG_SYSTEM_API char const* GetJsonErrorMessage( rapidjson::ParseErrorCode code );

    // File reader
    //-------------------------------------------------------------------------

    class KRG_SYSTEM_API JsonArchiveReader
    {
    public:
    ...
    class KRG_SYSTEM_API JsonArchiveWriter
    {
    public:
