...
namespace KRG
{
    namespace Threading
    {
        ...
        KRG_SYSTEM_API ProcessorInfo GetProcessorInfo();
        ...
        class KRG_SYSTEM_API SyncEvent
        {
        public:
        ...
        KRG_SYSTEM_API bool IsMainThread();

        //-------------------------------------------------------------------------
        // Global State
        //-------------------------------------------------------------------------

        KRG_SYSTEM_API void Initialize( char const* pMainThreadName );
        KRG_SYSTEM_API void Shutdown();
        KRG_SYSTEM_API ThreadID GetCurrentThreadID();
        KRG_SYSTEM_API void SetCurrentThreadName( char const* pName );
    }
}