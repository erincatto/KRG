...
namespace KRG::ImGuiX
{
    ...
    struct KRG_SYSTEM_API SystemFonts
    {
    ...
    class KRG_SYSTEM_API [[nodiscard]] ScopedFont
    {
    public:
    ...
    KRG_SYSTEM_API inline void PushFont( Font font ) 
    {
        ImGui::PushFont( SystemFonts::s_fonts[(int8_t) font] ); 
    }

    KRG_SYSTEM_API inline void PushFontAndColor( Font font, ImColor const& color ) 
    {
        ImGui::PushFont( SystemFonts::s_fonts[(int8_t) font] );
        ImGui::PushStyleColor( ImGuiCol_Text, color.Value );
    }

    KRG_SYSTEM_API inline void PushFontAndColor( Font font, Color const& color )
    {
        ImGui::PushFont( SystemFonts::s_fonts[(int8_t) font] );
