...
namespace KRG
{
    ...
    class KRG_SYSTEM_API MemoryStream final : public std::iostream
    {
        struct KRG_SYSTEM_API Buffer final : public std::streambuf
        {
    ...
    class KRG_SYSTEM_API MemoryStreamView final : public std::istream
    {
