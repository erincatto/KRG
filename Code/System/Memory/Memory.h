...
namespace KRG
{
    namespace Memory
    {
        ...
        KRG_SYSTEM_API void InitializeThreadHeap();
        KRG_SYSTEM_API void ShutdownThreadHeap();
        ...
        KRG_SYSTEM_API size_t GetTotalRequestedMemory();
        KRG_SYSTEM_API size_t GetTotalAllocatedMemory();
    }
    ...
    [[nodiscard]] KRG_SYSTEM_API void* Alloc( size_t size, size_t alignment = KRG_DEFAULT_ALIGNMENT );
    [[nodiscard]] KRG_SYSTEM_API void* Realloc( void* pMemory, size_t newSize, size_t originalAlignment = KRG_DEFAULT_ALIGNMENT );
    KRG_SYSTEM_API void Free( void*& pMemory );
