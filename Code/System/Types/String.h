...
namespace KRG
{
    ...
    namespace StringUtils
    {
        ...
        {
            KRG_ASSERT( pStringToMatch != nullptr );
            size_t const matchStrLen = strlen( pStringToMatch );
            KRG_ASSERT( matchStrLen > 0 );
        ...
        KRG_SYSTEM_API int32_t CompareInsensitive( char const* pStr0, char const* pStr1 );
        KRG_SYSTEM_API int32_t CompareInsensitive( char const* pStr0, char const* pStr1, size_t n );
