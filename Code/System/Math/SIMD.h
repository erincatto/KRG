...
namespace KRG
{
    namespace SIMD
    {
        ...
        namespace Int
        {
            KRG_FORCE_INLINE bool Equal( __m128 V1, __m128 V2 )
            {
                __m128i vTemp = _mm_cmpeq_epi32( _mm_castps_si128( V1 ), _mm_castps_si128( V2 ) );
                return ( ( ( _mm_movemask_ps( _mm_castsi128_ps( vTemp ) ) & 7 ) == 7 ) != 0 );
            }

            KRG_FORCE_INLINE bool NotEqual( __m128 V1, __m128 V2 )
            {
                __m128i vTemp = _mm_cmpeq_epi32( _mm_castps_si128( V1 ), _mm_castps_si128( V2 ) );
                return ( ( _mm_movemask_ps( _mm_castsi128_ps( vTemp ) ) != 0xF ) != 0 );
            }

            KRG_FORCE_INLINE __m128 And( __m128 V1, __m128 V2 )
            {
                return _mm_and_ps( V1, V2 );
            }

            KRG_FORCE_INLINE __m128 Or( __m128 V1, __m128 V2 )
            {
