...
namespace KRG::Math
{
    ...
    class KRG_SYSTEM_API ViewVolume
    {
    ...
    KRG_SYSTEM_API Matrix CreatePerspectiveProjectionMatrix( float verticalFOV, float aspectRatio, float nearPlaneZ, float farPlaneZ );

    // Creates a right handed orthographic projection matrix
    KRG_SYSTEM_API Matrix CreateOrthographicProjectionMatrix( float width, float height, float nearPlaneZ, float farPlaneZ );
}