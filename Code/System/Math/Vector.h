...
namespace KRG
{
    ...
    public:
        ...
        KRG_FORCE_INLINE Vector Get2D() const { return Vector::Select( *this, Vector::Zero, Vector::Select0011 ); }
        
        // Returns only the first three components, w = 0
        KRG_FORCE_INLINE Vector Get3D() const { return Vector::Select( *this, Vector::Zero, Vector::Select0001 ); }
        ...
        KRG_FORCE_INLINE bool IsNormalized2() const { return ( LengthSquared2() - Vector::One ).Abs().IsLessThanEqual4( Vector::NormalizeCheckThreshold ); }
        KRG_FORCE_INLINE bool IsNormalized3() const { return ( LengthSquared3() - Vector::One ).Abs().IsLessThanEqual4( Vector::NormalizeCheckThreshold ); }
        KRG_FORCE_INLINE bool IsNormalized4() const { return ( LengthSquared4() - Vector::One ).Abs().IsLessThanEqual4( Vector::NormalizeCheckThreshold ); }
