...
namespace KRG
{
    namespace Math
    {
        ...
        public:
            ...
            KRG_FORCE_INLINE Vector GetArea() const
            {
            ...
            KRG_FORCE_INLINE bool IsDegenerate() const
            {
                return GetArea().IsZero4();
            }

            KRG_FORCE_INLINE Vector GetPerimeter() const
            {
                Vector const V1V0 = m_vert1 - m_vert0;
                Vector const V2V0 = m_vert2 - m_vert0;
            ...
            KRG_FORCE_INLINE Vector GetCentroid() const
            {
                static Vector const vOneDivThree( 1.0f / 3 );
                return ( m_vert0 + m_vert1 + m_vert2 ) * vOneDivThree;
            }

            KRG_FORCE_INLINE Vector GetIncenter() const
            {
            ...
            KRG_FORCE_INLINE Vector GetCircumcenter() const
            {
                KRG_UNIMPLEMENTED_FUNCTION();
                return Vector();
            }

            KRG_FORCE_INLINE Vector GetOrthocenter() const
            {
                KRG_UNIMPLEMENTED_FUNCTION();
                return Vector();
            }
