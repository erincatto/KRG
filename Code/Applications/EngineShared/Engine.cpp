...
namespace KRG
{
    ...
    bool Engine::InitializeNonCoreModules( IniFile const& iniFile )
    {
        // !!! Order is important !!!
        //-------------------------------------------------------------------------
        ...
        if ( !m_module_engine_render.Initialize( m_moduleContext, iniFile ) )
        {
            return m_fatalErrorHandler( "Failed to initialize module" );
        }

        if ( !m_module_engine_physics.Initialize( m_moduleContext, iniFile ) )
        {
            return m_fatalErrorHandler( "Failed to initialize module" );
        }

        if ( !m_module_engine_animation.Initialize( m_moduleContext, iniFile ) )
        {
            return m_fatalErrorHandler( "Failed to initialize module" );
        }

        if ( !m_module_engine_navmesh.Initialize( m_moduleContext, iniFile ) )
        {
            return m_fatalErrorHandler( "Failed to initialize module" );
        }
        ...
        if ( !m_module_game_core.Initialize( m_moduleContext, iniFile ) )
        {
            return m_fatalErrorHandler( "Failed to initialize module" );
        }
    ...
    void Engine::ShutdownNonCoreModules()
    {
        // !!! Order is important !!!
        //-------------------------------------------------------------------------
    ...
    bool Engine::Initialize( String const& applicationName, Int2 const& windowDimensions )
    {
        ...
        if ( !m_module_engine_core.Initialize( m_moduleContext, iniFile ) )
        {
        ...
        if ( !InitializeNonCoreModules( iniFile ) )
        {
        ...
        for ( auto pModule : m_modules )
        {
            if ( !pModule->VerifyModuleResourceLoadingComplete() )
            {
