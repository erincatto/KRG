...
namespace KRG::VisualGraph
{
    ...
    namespace SM
    {
        class KRG_ENGINETOOLS_API Node : public BaseNode
        {
        ...
        class KRG_ENGINETOOLS_API State : public Node
        {
            friend StateMachineGraph;
            friend GraphView;
        ...
        class KRG_ENGINETOOLS_API TransitionConduit : public Node
        {
            friend StateMachineGraph;
            friend GraphView;
    ...
    class KRG_ENGINETOOLS_API StateMachineGraph : public BaseGraph
    {
