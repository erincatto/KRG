...
namespace KRG
{
    ...
    class KRG_ENGINETOOLS_API GenericResourceWorkspace : public EditorWorkspace
    {
    ...
    class KRG_ENGINETOOLS_API ResourceWorkspaceFactory : public TGlobalRegistryBase<ResourceWorkspaceFactory>
    {
