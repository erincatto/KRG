...
namespace KRG
{
    ...
    #define KRG_DECLARE_GLOBAL_REGISTRY( T ) friend TGlobalRegistryBase<T>; static T* s_pHead; static T* s_pTail;
    #define KRG_DEFINE_GLOBAL_REGISTRY( T ) T* T::s_pHead = nullptr; T* T::s_pTail = nullptr;
}