...
{
    class KRG_ENGINETOOLS_API TrackItem : public IRegisteredType
    {
    ...
    class KRG_ENGINETOOLS_API Track : public IRegisteredType
    {
    ...
    class KRG_ENGINETOOLS_API TrackContainer
    {
