...
namespace KRG::Animation::GraphNodes
{
    ...
    {
        KRG_REGISTER_TYPE( CachedBoolEditorNode );
    ...
    private:
        ...
        KRG_EXPOSE CachedValueMode          m_mode = CachedValueMode::OnEntry;
    };
    ...
    {
        KRG_REGISTER_TYPE( CachedIDEditorNode );
    ...
    {
        KRG_REGISTER_TYPE( CachedIntEditorNode );
    ...
    {
        KRG_REGISTER_TYPE( CachedFloatEditorNode );
    ...
    {
        KRG_REGISTER_TYPE( CachedVectorEditorNode );
    ...
    {
        KRG_REGISTER_TYPE( CachedTargetEditorNode );
