...
namespace KRG
{
    ...
    class KRG_ENGINE_API RuntimeSetting
    {
    ...
    class KRG_ENGINE_API RuntimeSettingBool : public RuntimeSetting
    {
    ...
    class KRG_ENGINE_API RuntimeSettingInt : public RuntimeSetting
    {
    ...
    class KRG_ENGINE_API RuntimeSettingFloat : public RuntimeSetting
    {
...
namespace KRG
{
    class KRG_ENGINE_API SettingsRegistry : public ISystem
    {
