...
namespace KRG::Navmesh
{
    struct KRG_ENGINE_API NavmeshLayerBuildSettings : public IRegisteredType
    {
        ...
        KRG_EXPOSE StringID                                 m_layerID; // User supplied layer ID to help identify layers, not actually used
    ...
    struct KRG_ENGINE_API NavmeshBuildSettings : public IRegisteredType
    {
        ...
        KRG_EXPOSE NavmeshLayerBuildSettings                m_defaultLayerBuildSettings;
        KRG_EXPOSE TVector<NavmeshLayerBuildSettings>       m_additionalLayerBuildSettings;
    ...
    private:
        ...
        #if KRG_DEVELOPMENT_TOOLS
        KRG_EXPOSE NavmeshBuildSettings                       m_buildSettings;
        #endif

        KRG_REGISTER TResourcePtr<NavmeshData>                m_pNavmeshData;
    };
}