...
namespace KRG
{
    ...
    class KRG_ENGINE_CORE_API RuntimeSetting
    {
    ...
    class KRG_ENGINE_CORE_API RuntimeSettingBool : public RuntimeSetting
    {
    ...
    class KRG_ENGINE_CORE_API RuntimeSettingInt : public RuntimeSetting
    {
    ...
    class KRG_ENGINE_CORE_API RuntimeSettingFloat : public RuntimeSetting
    {
...
namespace KRG
{
    class KRG_ENGINE_CORE_API SettingsRegistry : public ISystem
    {
