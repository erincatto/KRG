...
namespace KRG
{
    struct KRG_ENGINE_CORE_API ExternalTestSubSubStruct : public IRegisteredType
    {
    ...
    struct KRG_ENGINE_CORE_API ExternalTestSubStruct : public IRegisteredType
    {
    ...
    struct KRG_ENGINE_CORE_API ExternalTestStruct : public IRegisteredType
    {
    ...
    class KRG_ENGINE_CORE_API TestComponent : public EntityComponent
    {
