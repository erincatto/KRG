...
namespace KRG::Animation::GraphNodes
{
    ...
    void BoneMaskNode::InitializeInternal( GraphContext& context )
    {
        ...
        {
            m_boneMask.ResetWeights( pSettings->m_weights, pSettings->m_rootMotionWeight );
        }
    }
    ...
    {
        KRG_ASSERT( context.IsValid() && m_pBlendWeightValueNode != nullptr && m_pSourceBoneMask != nullptr && m_pTargetBoneMask != nullptr );
